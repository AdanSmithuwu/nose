...
public interface TipoMovimientoResourceApi {
    @Context
    @GET
    ...
    /** Envoltura de conveniencia usada por {@link com.comercialvalerio.application.service.TipoMovimientoService#buscarPorNombre}. */
    ...
    @POST
    public Response crear(@Valid TipoMovimientoCreateDto dto);

    @PUT @Path("{id}")
    public Response actualizar(@PathParam("id") @NotNull Integer id, @Valid TipoMovimientoCreateDto dto);
