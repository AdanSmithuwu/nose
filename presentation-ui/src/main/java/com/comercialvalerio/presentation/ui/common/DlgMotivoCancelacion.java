...
import com.comercialvalerio.presentation.controller.common.MotivoCancelacionController;
import javax.swing.*;
...
/**
 * Diálogo para ingresar el motivo de cancelación de un pedido o venta.
 */
public class DlgMotivoCancelacion extends BaseDialog {

    private final JTextArea txtMotivo = new JTextArea(6, 30);
    private final JButton   btnGuardar;
    private final JButton   btnCancelar = new JButton("Cancelar");
    private final MotivoCancelacionController controller;

    public DlgMotivoCancelacion(Window owner) {
        super(owner, "Motivo de Cancelación", ModalityType.APPLICATION_MODAL, new JButton("Guardar"));
        this.btnGuardar = getDefaultButton();
        this.controller = new MotivoCancelacionController(this);
        ...
        buildUI();
        SwingUtilities.invokeLater(() -> txtMotivo.requestFocusInWindow());
    ...
    private void buildUI() {
        ...
        ((javax.swing.text.AbstractDocument) txtMotivo.getDocument())
                .setDocumentFilter(new LengthFilter(DbConstraints.LEN_OBSERVACION));
        JScrollPane sp = new JScrollPane(txtMotivo);
        root.add(sp, "grow, h " + DbConstraints.LEN_OBSERVACION + "!, wrap");
    ...
    public MotivoCancelacionController getController() { return controller; }
