...
public class DarkLightSwitchIcon implements AnimatedIcon {
    ...
    private Icon darkIcon = new FlatSVGIcon(
                "com/comercialvalerio/presentation/ui/login/mode/dark.svg", 0.8f);
    private Icon lightIcon = new FlatSVGIcon(
                "com/comercialvalerio/presentation/ui/login/mode/light.svg", 0.8f);
